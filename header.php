	...
	<header id="masthead" class="header-main " <?php if ( $post_header_background_color && ! is_home() && ! is_category() ) echo 'style="background: ' . $post_header_background_color . '"'; ?>>
		<div class="container header-main-inner">
			...
			if( $nav_btn && ! $post_nav_btn ):
				...
				?>
				<a class="nav-button il_btn button-color-bbw button-hover-color-tpp" href="<?php echo esc_url( $nav_btn_url ); ?>" target="<?php echo esc_attr( $nav_btn_target ); ?>"><?php echo esc_html( $nav_btn_title ); ?></a>
			<?php endif; ?>
			<?php 
			if( $post_nav_btn ):
			...
			<?php endif; ?>
			<a href="#" class="header-login-btn"><img src="/wp-content/uploads/2025/04/user-1-1.svg" alt="Login">LOGIN</a>
		</div>
	</header><!-- #masthead -->
